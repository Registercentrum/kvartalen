Repository.Local.Methods.initialize({
    ...
    isWithinRange: function (aRegistration, aPeriod, aYear) {
        ...
        if (aPeriod <= 4) {
            return aRegistration.Period === aPeriod && aRegistration.YearOfPeriod === aYear;
        }
        ...
        var f = aPeriod.toString().indexOf(aRegistration.Period.toString()) + 1 >= aRegistration.Period;
        ...
        Ext.Array.forEach(db.Indicators, function (rc) {
            if (rc.Indicator === ic) {
                ...
                if (rc.Gender === gc && rc.Administration === ma) {
                    ...
                    curr.ycs[rc.YearOfPeriod] = curr.ycs[rc.YearOfPeriod] || true;
                }
            }
        });
    },
    ...
    init: function (_m) {
        ...
        typeof QuarterlyIndicatorModel === 'undefined' && Ext.define('QuarterlyIndicatorModel', {
...
//# sourceURL=SID/IndicatorsForQuarters