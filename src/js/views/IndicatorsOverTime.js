    ...
    function init() {
        var container =
            (window.Stratum &&
                ...
                window.Stratum.containers['SID/IndicatorsOverTimeKS']) ||
            'main-container';
        Repository.Local.Methods.initialize({
            ...
            getManagementValues: function() {
                ...
                function firstPassFilter(rc) {
                    return (
                        rc.Indicator === ic &&
                        (rc.Administration == ac ||
                            rc.Administration == 55555) &&
                ...
                var firstFilter = Ext.Array.filter(
                    db.Indicators,
                    firstPassFilter
                );
                hasQuarters = Ext.Array.some(
                    firstFilter,
                    helpers.checkForQuarters
                );
                var secondFilter = Ext.Array.filter(
                    firstFilter,
                    secondPassRule
                );
                ...
                var vc = Ext.Object.getValues(returnHash).sort(
                    helpers.sortByQuarter
                );
            ...
            init: function(_m) {
                        ...
                        listeners: {
                            itemclick: {
                                fn: function(legend, model, el) {
                                    var seriesSurface =
                                        widget._chart.getSeries().length &&
                                        widget._chart
                                            .getSeries()[0]
                                            .getSurface();
                ...
                var getPicBtn = Ext.create('Ext.Button', {
                    ...
                    handler: function() {
                        ...
                        var filename =
                            'Indikatorvärden_över_tid-' + today + '.png';
                        // Get the text Items
...
//# sourceURL=SID/IndicatorsOverTimeKS
